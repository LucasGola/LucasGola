...
## **Contatos**
  ...
  <div style="margin-left: 40px" >
    <div style="margin-bottom: 20px">
      <img src="./assets/outlook.png" style="height: 30px; vertical-align: middle" alt="email" >
      <span style="margin-left: 10px">lucasgola@outlook.com</span>
    </div>
    <div style="margin-bottom: 20px">
      <img src="./assets/linkedin.png" style="height: 30px; vertical-align: middle" alt="email" >
      <span style="margin-left: 10px">https://www.linkedin.com/in/lucasgola/</span>
    </div>
    <div style="margin-bottom: 20px">
      <img src="./assets/whatsapp.png" style="height: 30px; vertical-align: middle" alt="email" >
      <span style="margin-left: 10px">+55 11 99448-5761</span>
    </div>
    <div style="margin-bottom: 20px">
      <img src="./assets/telephone.png" style="height: 30px; vertical-align: middle" alt="email" >
      <span style="margin-left: 10px">+55 11 99448-5761</span>
    </div>
  </div>
